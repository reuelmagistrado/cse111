def main():
    ...
    # Call the make_known_molecules function and
    # store the known molecules dictionary in a variable
    known_molecules_dict = make_known_molecules()

    # Call the get_formula_name function to check if the
    # formula entered by the user is in the known molecules dictionary
    ...
    symbol_quantity_list = parse_formula(
        formula=molecular_formula, periodic_table_dict=periodic_table)

    # Call the sum_protons functionto compute
    # the total number of protons of the molecule
    ...
    print(f"Number of Protons: {number_of_protons} protons")

    # Print the molar mass.
    print(f"Total Molar Mass: {total_molar_mass:.5f} grams/mole")
...
def make_periodic_table():
    """Create a periodic table dictionary

    Parameters: none
    Return: compound list of periodic table
    """
    periodic_table_list = {
...
def make_known_molecules():
    """Create known molecules dictionary

    Parameters: none
    Return: known molecules dictionary
    """
...
def get_formula_name(formula, known_molecules_dict):
    ...
    Parameters
        ...
        known_molecules_dict: a dictionary returned from make_known_molecules function

    Return:
        Chemical formula name: if the formula is in the keys of known_molecules_dict
        "unknown compound": if the formula is not in the keys of known_molecules_dict
    """
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
    ...
    # Multiply the atomic mass by the quantity.
        atomic_number_product = atomic_number * quantity
    # Add the product into the total molar mass.
        total_atomic_number += atomic_number_product
